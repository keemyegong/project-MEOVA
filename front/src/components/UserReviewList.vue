<template>
  <div class="nato-font">
    <p class="review-item-title">
      {{
        userStore.profile_info.nickname
          ? userStore.profile_info.nickname
          : userStore.profile_info.username
      }}`s Reviews
    </p>
    <div v-if="reviews" class="review">
      <div v-for="review in reviews.slice().reverse()" :key="review.id">
          ...
          <div class="card-body review-box">
            ...
            >
              <div class="movie-info">
                ...
                />
                <span
                  class="movie-title ms-3 card-subtitle mt-2 text-body-secondary"
                >
                  {{ review.movie.title }}
                </span>
              </div>
